...
swiperslideelement.setAttribute("src", `https://raw.githubusercontent.com/UESHITA-FMHP/Web-File/main/img-1-AM.jpg`);
swiperslideelement = document.getElementById(`background-img2`);
swiperslideelement.setAttribute('src', `https://raw.githubusercontent.com/UESHITA-FMHP/Web-File/main/img-2-AM.jpg`);
swiperslideelement = document.getElementById(`background-img3`);
swiperslideelement.setAttribute('src', `https://raw.githubusercontent.com/UESHITA-FMHP/Web-File/main/img-3-AM.jpg`);
...
swiper.on('slideChange', function () {
    if (swiper.previousIndex < swiper.snapIndex && swiper.snapIndex < 30) {
        ...
        swiperslideelement.setAttribute("src", `https://raw.githubusercontent.com/UESHITA-FMHP/Web-File/main/img-${swiper.snapIndex + 3}-AM.jpg`);
    }
...
function imgopen() {
    ...
    imgpopupimgelement.setAttribute("src", `https://raw.githubusercontent.com/UESHITA-FMHP/Web-File/main/img-${swiper.snapIndex + 1}-AM.jpg`);
    imgpopupelement.style.display = "block";
};

function answerbtn() {
    imgpopupimgelement.setAttribute("src", `https://raw.githubusercontent.com/UESHITA-FMHP/Web-File/main/img-${swiper.snapIndex + 1}-BM.jpg`);
